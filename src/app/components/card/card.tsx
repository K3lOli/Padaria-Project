...
import { addCarrinho } from "@/app/store/reducers/carrinho";
  ...
  return (
    <div>
      <div className="w-[240px] h-[290px] bg-[#342A35] rounded-[1.25rem] flex flex-col items-center mt-6 justify-between">
        ...
        <div className="w-[214px] bg-[#453C47] rounded-full flex justify-between items-center mb-6">
          <h2 className="text-[24px] text-white ml-3">R${price}</h2>
          <button className="bg-white w-[3.81vw] h-10 rounded-full flex justify-center items-center" onClick={resolverCarrinho}>
